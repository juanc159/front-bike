    ...
    >
      <VCard title="Formulario de la compañia">
        ...
        <VRow class=" mr-3 ml-4 mb-4">
          ...
          <VCol cols="4">
            <VFileInput
              ...
              accept="image/*"
              :rules="arrayValidator.logo"
              @change="logo.handleImageSelected"
            >
              />
            </VFileInput>
          </VCol>
        ...
        <VRow class="mb-4">
          <VCol cols="12">
            <VImg
              contain
              :src="logo.imageUrl ?? formulario.logo"
              alt="foto Personal"
              :max-width="200"
              class="mx-auto"
            />
      ...
      >
        <VRow class=" mr-3 ml-4 mb-4">
          ...
          <VCol cols="4">
            <VTextField
              v-model="formulario.identification_rep"
              :error-messages="errors.identification_rep"
              label="Cédula de representante legal"
              maxlength="15"
        ...
        <VRow class=" mr-3 ml-4 mb-4">
          <VCol cols="4">
            <VTextField
              v-model="formulario.address_rep"
              :error-messages="errors.address_rep"
              label="Dirección de representante legal"
              maxlength="50"
          ...
          <VCol cols="4">
            <VTextField
              v-model="formulario.email_rep"
              type="email"
              :error-messages="errors.email_rep"
