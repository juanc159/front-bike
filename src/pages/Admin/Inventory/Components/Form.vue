  ...
  <div>
    ...
    > 
      <VRow>
        <VCol cols="12" md="4">
          <VTextField
            ...
            label="Item"
            @keypress="errors.item = ''"
          />
        </VCol>
        <VCol cols="12" md="4">
          <VTextField
            v-model="formulario.reference"
            :rules="[requiredValidator]"
            autocomplete="off"
            :error-messages="errors.reference"
            label="Referencia"
            @keypress="errors.reference = ''"
          />
        </VCol>
         
        <VCol cols="12" md="4">
          <VTextField
            v-model="formulario.brand"
            :rules="[requiredValidator]"
        ...
        <VCol cols="12" md="4">
          <VTextField
            v-model="formulario.model"
            :rules="[requiredValidator]"
            :error-messages="errors.model"
            label="Modelo"
            @keypress="errors.model = ''"
          />
        </VCol>
      ...
      <VRow>
        <VCol cols="12" md="4">
          <VTextField
            v-model="formulario.registrationSite"
            maxlength="15"
            :rules="[requiredValidator]"
            :error-messages="errors.registrationSite"
            label="Sitio de matricula"
            @keypress="errors.registrationSite = '';"
          />
        </VCol> 
        <VCol cols="12" md="4">
          <VTextField
            v-model="formulario.value"
            maxlength="15"
            :rules="[requiredValidator]"
            :error-messages="errors.value"
            label="Valor"
            @keypress="errors.value = '';"
          />
        </VCol> 
      </VRow> 
      <VRow>
