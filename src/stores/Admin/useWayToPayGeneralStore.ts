...
import IGeneralList from "@/interfaces/Admin/WayToPay/IGeneralList";
import IFormGeneral from "@/interfaces/Admin/WayToPay/IFormGeneral";
...
export const useWayToPayGeneralStore = defineStore("useWayToPayGeneralStore", {
  state: () => ({
    loading: false as boolean,
    typeAction: "list" as string,
    generals: [] as Array<IGeneralList>,
